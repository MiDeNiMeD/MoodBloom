...
const Settings: React.FC = () => {
  ...
  const resetPlantProgress = () => {
    if (confirm('Are you sure you want to reset your plant? This will not delete your mood entries.')) {
  ...
  const exportData = () => {
    ...
    a.href = url;
    a.download = `moodbloom-export-${new Date().toISOString().split('T')[0]}.json`;
    a.click();
    ...
    <div>
      ...
      <div className="card mb-6">
        ...
        <p className="text-neutral-600 mb-4">
          Select the type of plant you'd like to grow based on your mood entries.
        </p>
        ...
        <div className="space-y-4">
          ...
          <div>
            <button 
              ...
              onClick={resetPlantProgress}
            >
              Reset Plant Progress
            </button>
            <p className="text-sm text-neutral-500 mt-1">
              Start your plant growth from the beginning while keeping your mood entries.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500 mt-1">
              Permanently delete all your mood entries and reset settings. This cannot be undone.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <p className="text-neutral-600 mb-2">
          MoodBloom helps you track your daily moods while visualizing your emotional well-being through a growing plant. 
        </p>
